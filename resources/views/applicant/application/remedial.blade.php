...
<div class="accordion" id="applicationAccordion">
    ...
    <div class="accordion-item border-0 rounded-3 mb-3">
        <h2 class="accordion-header">
            <button class="accordion-button fw-semibold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#institutionsSection">
                <i class="material-symbols-outlined me-2">school</i> Post Primary Institutions Attended
            </button>
        </h2>
        <div id="institutionsSection" class="accordion-collapse collapse" data-bs-parent="#applicationAccordion">
            <div class="accordion-body">
                <form action="{{ route('applicant.application.schools') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm mt-2" style="background:#006633;border-color:#006633;">Save Institutions</button>
                    @endif
                </form>
            </div>
        </div>
    ...
    <div class="accordion-item border-0 rounded-3 mb-3">
        <h2 class="accordion-header">
            <button class="accordion-button fw-semibold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#resultsSection">
                <i class="material-symbols-outlined me-2">grading</i> Examination Results (O'Level)
            </button>
        </h2>
        <div id="resultsSection" class="accordion-collapse collapse" data-bs-parent="#applicationAccordion">
            <div class="accordion-body">
                <form action="{{ route('applicant.application.results') }}" method="POST">
                    ...
                    @if(!$isSubmitted)
                    <button type="submit" class="btn btn-primary btn-sm mt-2" style="background:#006633;border-color:#006633;">Save Results</button>
                    @endif
                </form>
            </div>
        </div>
    ...
    <div class="accordion-item border-0 rounded-3 mb-3">
        <h2 class="accordion-header">
            <button class="accordion-button fw-semibold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sponsorSection">
                <i class="material-symbols-outlined me-2">volunteer_activism</i> Sponsorship, Activities & Employment
            </button>
        </h2>
        <div id="sponsorSection" class="accordion-collapse collapse" data-bs-parent="#applicationAccordion">
            <div class="accordion-body">
                <form action="{{ route('applicant.application.sponsorship') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm mt-2" style="background:#006633;border-color:#006633;">Save Sponsorship & Activities</button>
                    @endif
                </form>
            </div>
        </div>
