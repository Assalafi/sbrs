...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <h3 class="fw-semibold mb-0">Admission Fee Payment</h3>
...
<div class="row">
    <div class="col-lg-8">
        <div class="alert alert-success mb-4">
            <i class="material-symbols-outlined me-2 align-middle">celebration</i>
            <strong>Congratulations!</strong> Your application has been approved. Pay the admission fee to complete your admission.
        </div>
        ...
        <div class="card border-0 rounded-3 mb-4">
            ...
            <div class="card-body p-4">
                @if(!$fee)
                    <div class="alert alert-warning mb-0">No admission fee configured. Please contact admin.</div>
                @else
                        ...
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-success">{{ $applicant->programme_type }}</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr class="border-top">
                                    <td class="text-muted fs-5">Admission Fee:</td>
            ...
            <div class="card-body p-4">
                @if($payment && $payment->hasRrr())
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <form id="verify-form" action="{{ route('applicant.payment.admission-fee.verify') }}" method="GET">
                ...
                @else
                    <form action="{{ route('applicant.payment.admission-fee.initiate') }}" method="POST">
                        @csrf
                        <div class="d-grid">
        ...
        <div class="card border-0 rounded-3 mb-4">
            ...
            <div class="card-body">
                <ol class="mb-0">
                    ...
                    <li>Once verified, you can download your admission letter.</li>
                </ol>
            </div>
        </div>
