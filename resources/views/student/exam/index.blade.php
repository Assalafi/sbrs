...
@section('title', 'Examination Fee')

@section('content')
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <h3 class="fw-semibold mb-0">Examination Fee</h3>
...
<div class="alert alert-success">
    <i class="material-symbols-outlined align-middle">check_circle</i>
    <strong>Paid!</strong> Your examination fee has been paid and verified successfully.
</div>
@endif
    ...
    <div class="col-lg-8">
        <div class="card border-0 rounded-3 mb-4">
            ...
            <div class="card-body p-4">
                @if(!$fee)
                    <div class="alert alert-warning mb-0">No examination fee configured. Contact admin.</div>
                @else
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                <tr>
                                    <td class="text-muted" width="40%">Student Name:</td>
                                    <td class="fw-bold">{{ $student->surname }} {{ $student->first_name }} {{ $student->other_names }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-info">{{ $student->programme_type }}</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr class="border-top">
                                    <td class="text-muted fs-5">Examination Fee:</td>
        ...
        @if($fee && (!$payment || $payment->status !== 'successful'))
        <div class="card border-0 rounded-3 mb-4">
            <div class="card-header bg-transparent">
            ...
            <div class="card-body p-4">
                @if($payment && $payment->hasRrr())
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <form id="verify-form" action="{{ route('student.exam.verify') }}" method="GET">
                ...
                @else
                    <form action="{{ route('student.exam.initiate') }}" method="POST">
                        @csrf
                        <div class="d-grid">
        ...
        <div class="card border-0 rounded-3 mb-4">
            ...
            <div class="card-body">
                <ol class="mb-0">
                    ...
                    <li>Once verified, you are eligible to sit for examinations.</li>
                </ol>
            </div>
        </div>
...
@if(isset($payment) && $payment && $payment->hasRrr() && $payment->status !== 'successful')
