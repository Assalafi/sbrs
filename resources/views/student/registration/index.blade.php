...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <h3 class="fw-semibold mb-0">Student Registration</h3>
...
<div class="alert alert-success">
    ...
    <strong>Registered!</strong> You have completed your registration for this session.
</div>
@endif
    ...
    <div class="col-lg-8">
        <div class="card border-0 rounded-3 mb-4">
            ...
            <div class="card-body p-4">
                @if(!$fee)
                    <div class="alert alert-warning mb-0">No registration fee configured. Contact admin.</div>
                @else
                        ...
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary">{{ $student->programme_type }}</span></td>
                                </tr>
                                <tr>
                                ...
                                <tr class="border-top">
                                    <td class="text-muted fs-5">Registration Fee:</td>
            ...
            <div class="card-body p-4">
                @if($payment && $payment->hasRrr())
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <form id="verify-form" action="{{ route('student.registration.verify') }}" method="GET">
                ...
                @else
                    <form action="{{ route('student.registration.initiate') }}" method="POST">
                        @csrf
                        <div class="d-grid">
        ...
        <div class="card border-0 rounded-3 mb-4">
            ...
            <div class="card-body">
                <ol class="mb-0">
                    ...
                    <li>Once verified, your registration is complete and you can register courses.</li>
                </ol>
            </div>
        </div>
...
@if(isset($payment) && $payment && $payment->hasRrr() && !$student->is_registered)
