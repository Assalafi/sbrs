...
Route::prefix('student')->middleware(['student.auth'])->group(function () {
    ...
    Route::get('/payments/verify/{payment}', [StudentPaymentController::class, 'verify'])->name('student.payments.verify');
    Route::post('/payments/cancel/{payment}', [StudentPaymentController::class, 'cancel'])->name('student.payments.cancel');
    ...
    Route::get('/hostel/rooms', [\App\Http\Controllers\Student\HostelController::class, 'rooms'])->name('student.hostel.rooms');
    Route::get('/hostel/beds', [\App\Http\Controllers\Student\HostelController::class, 'beds'])->name('student.hostel.beds');
